...
# ============================================
# ESQUEMAS DE PARÁMETROS POR ACCIÓN
# ============================================
# Cada entrada define:
#   - "required": tupla de nombres de parámetros obligatorios con su tipo esperado.
#   - "optional": tupla de nombres de parámetros opcionales con su tipo esperado.
#
# Formato: {param_name: expected_type}
# Si el tipo es None, se acepta cualquier tipo.
