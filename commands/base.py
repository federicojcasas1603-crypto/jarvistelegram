...
class Command(ABC):
    ...
    def requires_confirmation(self) -> bool:
        """
        Indica si el comando requiere confirmación antes de ejecutar.

        Por defecto retorna False. Sobreescribir en comandos destructivos
        (shutdown, delete, etc.) para retornar True.
        """
        return False
